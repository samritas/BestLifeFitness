    ...
    <Box  sx={{   padding: 5,flexDirection: 'column', display: 'flex',justifyContent: 'center',
      ...
      <strong> 創業者紹介</strong>
       ...
       <Box 
              ...
              <Typography variant="body2" sx={{ mt: 2 ,color: '#E87F11', textAlign:'center'}}>
      ...
      <Typography variant="body2" sx={{ mt: 2,color: '#E87F11', }}>
...
<Typography variant="body2" sx={{ mt: 1 ,color: '#E87F11'}}>
  • 最高90歳近くの女性への運動指導
  <br />
  • 入院明けのリハビリテーションサポート
  <br />
...
<Typography variant="body2" sx={{ mt: 3, color: '#E87F11' }}>
